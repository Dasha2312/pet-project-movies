import { Alert, AlertTitle, Box, Button, Checkbox, FormControlLabel, FormGroup, MenuItem, Select } from '@mui/material';
...
function SupportForm({handleSubmitSupport, supportOnSubmit, Controller, controlSupport, watchSupport, isSuccessfullySubmittedSupport}) {
  console.log('isSuccessfullySubmittedSupport', isSuccessfullySubmittedSupport)
  const agreeCheck = watchSupport('agreeCheck')
  return (
    <>
      <form onSubmit={handleSubmitSupport(supportOnSubmit)}>
      ...
      {isSuccessfullySubmittedSupport && <Alert severity="success" sx={{marginTop: '20px'}}>
        <AlertTitle>Thank you!</AlertTitle>
         Your request has been successfully submitted to our support team. We will review your inquiry and get back to you as soon as possible. You will receive a confirmation email shortly.
      </Alert>}
    </>
  );
}
